...
// Weapon HUD
const uint iSlot			= 3;
const uint iPosition		= 6;

// Fire rate delay
const float flFRDelay =  0.25f;
const float flRLDelay =  0.15f;

class weapon_hlhornetgun : ScriptBasePlayerWeaponEntity
{
	int m_iFirePhase;
...
{
	return "weapon_hlhornetgun";
}

void RegisterDMHornetGun()
{
	RegisterDMhornet();
	g_CustomEntityFuncs.RegisterCustomEntity( "weapon_hlhornetgun", GetNameDMHornet() );
	g_ItemRegistry.RegisterWeapon( GetNameDMHornet(), "hl_weapons", "Hornet" );
}