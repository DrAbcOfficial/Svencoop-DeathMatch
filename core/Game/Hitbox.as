...
namespace pvpHitbox
{
    ...
    void PluginInit()
    {
        ...
        pvpHook::RegisteHook(CHookItem(@pvpHitbox::DisconnectHitbox, HOOK_DISCONNECT, "HITBOX_DISCONNECT"));
        pvpHook::RegisteHook(CHookItem(@pvpHitbox::RemoveHitbox, HOOK_KILLED, "HITBOX_KILLED"));
        pvpHook::RegisteHook(CHookItem(@pvpHitbox::playerSpawn, HOOK_SPAWN, "HITBOX_SPAWN"));
        pvpHook::RegisteHook(CHookItem(@pvpHitbox::checkPlayerHitbox, HOOK_PRETHINK, "HITBOX_PRETHINK"));
    }
    ...
    void DisconnectHitbox(CBasePlayer@ pPlayer)
    {
        RemoveIt(pPlayer);
    }

    void RemoveHitbox(CBasePlayer@ pPlayer, CBaseEntity@ pEntity)
    {
        RemoveIt(pPlayer);
    }

    void RemoveIt(CBasePlayer@ pPlayer)
    {
