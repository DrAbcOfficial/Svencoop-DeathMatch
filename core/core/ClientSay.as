namespace pvpClientSay
{
    ...
    void PluginInit()
    {
        ...
        arypreSayfuncs.insertLast(pvpSayFunc("Sayreplace", @paramentSayHook));
        //查看系统语言和可选语言
        pvpClientCmd::RegistCommand("admin_sayreplace","Toggle the say replace","Say", @pvpClientSay::sayRepCallback, CCMD_ADMIN);
    }
